...
namespace NSE.WebApp.MVC.Extensions
{
    ...
    public static class ClaimsPrincipalExtensions
    {
        ...
        {
            return Pesquisar(principal, "sub");
        }

        public static string GetUserEmail(this ClaimsPrincipal principal)
        {
            return Pesquisar(principal, "email");
        }

        public static string GetUserToken(this ClaimsPrincipal principal)
        {
            return Pesquisar(principal, "JWT");
        }

        private static string Pesquisar(ClaimsPrincipal principal, string parametro)
        {
            if (principal == null)
            {
            ...
            var claim = principal.FindFirst(parametro);
            return claim?.Value;
        }
    }
}
